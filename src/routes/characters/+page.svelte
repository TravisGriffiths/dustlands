...
<article>
   ...
   <section>
      ...
      <h3>Wares</h3>
      Known commonly as Raven Masters, or Messengers. The Cicle of Shifters keeps a low profile. Its practicioners are able to shift to any form desired as small as an insect to as large as a horse. These forms must be anchored, but the phyicallity of the transformation means that any hit with a confirmed hit to break concentration on a form. Large forms have 4 strikes, medium (human sized) 3 and smaller forms less. Shifters can shift in narrative time without difficulty, or a roll. In action time, a resistance roll set by the GM based on the difficulty of the tranformation must be met. Spells may not be cast while transformed.
      ...
      While the public certainly knows that shifters exist. The connection between them and the Messengers is carefully kept strictly under wraps. While shifters all learn thier craft under tutalage of teachers or masters just like any other sorcerer, the connection to the Messengers is just not spoken of. Nobody likes spies, even when they are working for you. 
      As to the Ravens themselves, mostly really are messenger birds. Quite a few beastmasters work closely with the birds training and caring for them. On other occasions, one or more shifters will take jobs themselves directly. The Circle of Shifters is one of the most united, and certainly most well informed organizations left in the world.
