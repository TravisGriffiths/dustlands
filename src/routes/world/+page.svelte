<article>
   ...
   <section>
      ...
      <h3>Cosmology</h3>
      At the poles days are called Turns. This is because it is one revolution of Grabin...a day, but being a polar zone, this does not corrispond to day and night. Grabin orbits its sun every twelve days. This causes the light and dark cycle break down into four turns of "Night" which are fully dark as the pole is inclanated away from the sun. There are four turns of "Day" when the inclanation is towards the sun during which tempratures get progressively hotter, becoming unbearable by the end. Between these are "Waning" and "Waxing" which are four turns of shortening and lengthening of the daylight period. 
      Night is never full darkness like here. First there is the Moon, which is very close, very large and moves very quickly across the sky, making 3 full orbits per turn. In addition, Tersus, the night star hangs shining in the night sky, moving around once per turn and giving off a wan white light. 
